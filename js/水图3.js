...
agriculturalStages.forEach(function (stage, idx) {
    ...
    singleAxis.push({
        ...
        type: 'category',
        boundaryGap: false,
        data: ecosystemIndicators,
        top: (idx * 100) / agriculturalStages.length + 5 + '%',
        height: 100 / agriculturalStages.length - 10 + '%',
        axisLabel: {
            interval: 1
        }
    });
...
ecosystemData.forEach(function (dataItem) {
